...
low_start_reed3 = None
delay_reed3 = None
previous_state_reed3 = 1
...
def reed1_falling_detect(reed1_pin):
    ...
    if first_time_reed1 == True: #to zadziala tylko przy pierwszym wejsciu
        ...
        #zapis do pliku csv
        try:
            with open('/media/CYKL/reed1.csv', 'a') as csvfile:
...
def reed2_falling_detect(reed2_pin):
    ...
    if first_time_reed2 == True: #to zadziala tylko przy pierwszym wejsciu
        ...
        #zapis do pliku csv
        try:
            with open('/media/CYKL/reed2.csv', 'a') as csvfile:
...
def reed3_falling_detect(reed3_pin):
    ...
    if first_time_reed3 == True: #to zadziala tylko przy pierwszym wejsciu
        ...
        #zapis do pliku csv
        try:
            with open('/media/CYKL/reed3.csv', 'a') as csvfile:
...
def main():
    ...
    optical_csv_exist = os.path.exists("/media/CYKL/optical.csv")
    ...
    reed1_csv_exist = os.path.exists("/media/CYKL/reed1.csv")
    ...
    reed2_csv_exist = os.path.exists("/media/CYKL/reed2.csv")
    ...
    reed3_csv_exist = os.path.exists("/media/CYKL/reed3.csv")
    ...
    delay_csv_exist = os.path.exists("delay.csv")
    ...
    while True:
        ...
        #global avr30_reed3
        #print("reed3 average30 : {}".format(avr30_reed3))
        #global avr_2shift_reed3
        #print("reed3 average 2shift : {}".format(avr_2shift_reed3))
        #global avr_1shift_reed3
        #print("reed3 average 1shift : {}".format(avr_1shift_reed3))
        #global avr_3shift_reed3
        #print("reed3 average 3shift : {}".format(avr_3shift_reed3))
        
        #delay
        
        #input_reed3 = gpio.input(reed3_pin)
        #print(input_reed3)
        #global low_start_reed3
        #global previous_state_reed3
        #if input_reed3 == 0 and previous_state_reed3 == 1: 
         #   low_start_reed3 = datetime.now()
          #  previous_state_reed3 = not previous_state_reed3
